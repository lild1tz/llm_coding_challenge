...
file_path = os.path.join(current_dir, "photo_examples.json")


with open(file_path, "r", encoding="utf-8") as file:
    examples_photo = json.load(file)
