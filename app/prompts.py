...
Чтобы корреткно выполнить задачу тебе нужно следовать инструкциям:
    ...
    7. ```operations``` - таблица списка операций
        ...
        Пример: 1-я междурядная культивация -> 1-я междурядная культивация
        Пример: 2-я междурядная культивация -> 2-я междурядная культивация
        Пример: 3-я междурядная культивация ->  3-я междурядная культивация (нет в таблице)
        Пример: Боронование довсходовое -> Боронование довсходовое
